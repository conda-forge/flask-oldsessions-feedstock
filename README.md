About flask-oldsessions-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-oldsessions-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/mitsuhiko/flask-oldsessions
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4910&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-oldsessions-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-oldsessions` can be installed with `conda`:
...
```
mamba install flask-oldsessions
```

It is possible to list all of the versions of `flask-oldsessions` available on your platform with `conda`:
...
```
mamba search flask-oldsessions --channel conda-forge
```
...
mamba repoquery search flask-oldsessions --channel conda-forge

# List packages depending on `flask-oldsessions`:
mamba repoquery whoneeds flask-oldsessions --channel conda-forge

# List dependencies of `flask-oldsessions`:
mamba repoquery depends flask-oldsessions --channel conda-forge
```
